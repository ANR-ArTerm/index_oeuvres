...
set "VALID_USERS=Pierre Julia Anna Emma Carla Nicolo Elisa Hortense Jules"
set "CURRENT_USER="
...
:ASK_USERNAME
color 0A
set /p USERNAME="Entrez votre nom d'utilisateur (Pierre, Julia, Anna, Emma, Carla, Nicolo, Elisa, Hortense, Jules) : "
color 07
